    ...
    public function userRegistrationMail($parameters) {
        ...
        if (!empty($parameters['email']) && !empty($parameters['name'])) {
            ...
            $replaceArrary = [
                ...
                '{{$confirmation_link}}' => '<a style="background-color: #00bb55;color: #fff;font-size: x-large;font-weight: bolder;padding: 10px 30px;text-decoration: none;" href="'.$this->baseUrl.'verify-email/'.$token.'">Verify Email</a>',
            ];
